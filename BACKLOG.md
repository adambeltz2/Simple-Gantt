...
- **Expand automated test coverage beyond the collapse/expand, in-progress-flag, dependency-scheduling, and csv-sanitization suites** (`tests/collapse-expand.spec.js`, `tests/flag-in-progress.spec.js`, `tests/dependency-scheduling.spec.js`, `tests/csv-sanitization.spec.js`). No coverage yet for CSV import/export round-tripping or the workload dashboard.
