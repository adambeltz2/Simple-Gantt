...
- **Expand automated test coverage beyond the collapse/expand, in-progress-flag, dependency-scheduling, csv-sanitization, inclusive-end-dates, and late-flag suites**. No coverage yet for CSV import/export round-tripping or the workload dashboard.
